...
const Features = () => {
  return (
    <div className="mt-16">
  <h1 className="text-6xl text-center font-bold">Our Projects</h1>
  ...
  <div className="mt-4 p-4 flex flex-col md:flex-row justify-center items-center gap-8">
    <div className="bg-gray-200 p-4 rounded-lg w-72 h-full hover:bg-purple-300 transition duration-300">
      ...
      <div className="mt-12 text-justify">
        <a href="https://sms.iemsbd.com/" className="text-black">
          <p className="mt-4 text-center text-xl  font-semibold">SMS Portal</p>
        </a>
    ...
    <div className="bg-gray-200 p-4 rounded-lg w-72 h-full hover:bg-purple-300 transition duration-300">
      ...
      <div className="mt-12 text-justify">
        <a href="https://dicmadrasha.com/home/events/dic" className="text-black">
          <p className="mt-4 text-center text-xl  font-semibold">Website of Madrasha</p>
        </a>
        <p className="mt-4 text-center font-sm">
          Explore a comprehensive platform dedicated to providing authentic Islamic teachings, resources, and educational materials.
        </p>
      </div>
    </div>
    <div className="bg-gray-200 p-4 rounded-lg w-72 h-full hover:bg-purple-300 transition duration-300">
      ...
      <div className="mt-12 text-justify">
        <p className="mt-4 text-center text-xl font-semibold">Accounts Management</p>
        <p className="mt-4 text-center font-sm">
    ...
    <div className="bg-gray-200 p-4 rounded-lg w-72 h-full hover:bg-purple-300 transition duration-300">
      ...
      <div className="mt-12 text-justify">
        <a href="https://task.baitsbd.com/" className="text-black">
          <p className="mt-4 text-center text-xl  font-semibold">Task Management</p>
        </a>
        <p className="mt-4 text-center font-sm">
          Product stock images in HD and millions of other royalty-free stock photos, illustrations, and vectors in the Shutterstock collection.
        </p>
      </div>
    </div>
  </div>
