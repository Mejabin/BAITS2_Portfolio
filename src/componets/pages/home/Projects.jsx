      ...
      <div className="mt-4 p-4 flex flex-col md:flex-row justify-center items-center gap-8">
        ...
        <div className="bg-gray-200 p-4 rounded-lg w-72 h-full hover:bg-purple-300 transition duration-300">
          ...
          <div className="mt-12 text-justify">
            ...
            <p className="mt-4 text-center font-sm">
              Explore a comprehensive platform dedicated to providing authentic
              Islamic teachings, resources, and educational materials.
            </p>
          </div>
        </div>
        <div className="bg-gray-200 p-4 rounded-lg w-72 h-full hover:bg-purple-300 transition duration-300">
          ...
          <div className="mt-12 text-justify">
            ...
            <p className="mt-4 text-center font-sm">
              Discover seamless financial management with user-friendly features
              designed to simplify your accounting tasks.
            </p>
          </div>
        </div>
        <div className="bg-gray-200 p-4 rounded-lg w-72 h-full hover:bg-purple-300 transition duration-300">
